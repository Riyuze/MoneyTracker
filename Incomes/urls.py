...
urlpatterns = [
    ...
    path('export-excel-incomes', views.export_excel_incomes, name="export-excel-incomes"),
    path('export-pdf-incomes', views.export_pdf_incomes, name="export-pdf-incomes"),
]
